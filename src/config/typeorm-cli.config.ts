...
import { addImageToRecipe1678344142300 } from "../migrations/1678344142300-add-image-to-recipe";
...
export default new DataSource({
  ...
  migrations: [initialSchema1678101163878,addUser1678176442196,addImageToRecipe1678344142300],
});